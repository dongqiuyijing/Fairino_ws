    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument(
                ...
                description="Gazebo j1 初始位置（弧度）。Stage 4 由 YAML Home 覆盖。",
            ),
            DeclareLaunchArgument(
                "initial_j2",
                default_value="-1.1927",
                description="Gazebo j2 初始位置（弧度）。Stage 4 由 YAML Home 覆盖。",
            ),
            DeclareLaunchArgument(
                "initial_j3",
                default_value="1.1129",
                description="Gazebo j3 初始位置（弧度）。Stage 4 由 YAML Home 覆盖。",
            ),
            DeclareLaunchArgument(
                "initial_j4",
                default_value="-1.1499",
                description="Gazebo j4 初始位置（弧度）。Stage 4 由 YAML Home 覆盖。",
            ),
            DeclareLaunchArgument(
                "initial_j5",
                default_value="-3.1393",
                description="Gazebo j5 初始位置（弧度）。Stage 4 由 YAML Home 覆盖。",
            ),
            DeclareLaunchArgument(
                "initial_j6",
                default_value="2.0996",
                description="Gazebo j6 初始位置（弧度）。Stage 4 由 YAML Home 覆盖。",
            ),
            ign_resource_path,
            gz_resource_path,
